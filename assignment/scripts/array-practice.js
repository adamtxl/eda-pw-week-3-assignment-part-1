...
let favoriteFoods = ['pizza', 'sushi', 'burgers', 'spaghetti'];
console.log(favoriteFoods , 'are among my favorite foods!')
...
console.log('Number of different food types:', numberOfFoods)
